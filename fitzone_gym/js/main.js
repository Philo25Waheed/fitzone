/*
 * ============================================================================
 * FRONTEND FILE - Main JavaScript (Client-Side Only)
 * ============================================================================
 * Purpose: Handle frontend interactivity, animations, and UI logic
 * Contains: Login demo (deprecated), calculators, exercise videos, streak tracking
 * 
 * IMPORTANT FOR FRONTEND TEAM:
 * - This file is FRONTEND ONLY - Safe to modify for UI features
 * - Note: Login/auth functions here are OLD and NOT USED (PHP backend handles auth)
 * - You can add new UI features, animations, and interactive elements here
 * 
 * IMPORTANT FOR BACKEND TEAM:
 * - Do not add backend logic here (use PHP files)
 * - Authentication is handled server-side (PHP), not client-side (JavaScript)
 * ============================================================================
 */

/* ===== FRONTEND: Main App Object ===== */
/* الكائن الرئيسي للتطبيق - يحتوي على جميع الوظائف */
const App = {
  init() {
    this.cache(); this.bind(); this.loadUser();
  },
  /* FRONTEND: Cache DOM Elements */
  /* تخزين العناصر من الصفحة للوصول السريع */
  cache() {
  ...
  bind() {
    ...
    /* FRONTEND: Contact Form Listener */
  ...
  /* FRONTEND: OLD AUTHENTICATION - NOT USED (PHP handles auth now) */
  /* هذه الدوال قديمة - لا تستخدم - التوثيق يتم عبر PHP */
  loadUser() {
  ...
  /* FRONTEND: Render Exercise List with Videos */
  /* عرض قائمة التمارين مع الفيديوهات */
  renderExercises() {
