...
/*
 * ============================================================================
 * FRONTEND FILE - Services Page
 * ============================================================================
 * Purpose: Display gym services, calculators, and training split options
 * 
 * IMPORTANT FOR FRONTEND TEAM:
 * - This file is mostly FRONTEND - Safe to modify UI/content
 * - Calculator forms call JavaScript functions (main.js)
 * ============================================================================
 */

// BACKEND: Include header
include 'includes/header.php';
?>

<!-- ===== FRONTEND: Services Page Content ===== -->
<!-- يمكن تعديل جميع المحتوى هنا -->
<div class="container">
  <!-- FRONTEND: Page Title -->
  <div class="panel">
